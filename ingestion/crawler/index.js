...
async function loadIgnoreFolders() {
  ...
  try {
    const file = await fs_1.default.promises.readFile(
      path_1.default.join(__dirname, 'ignore-folders.txt'),
      'utf8'
    );
    file
      .split(/\r?\n/)
...
function resolveExtensions(options) {
  ...
  if (
    (options === null || options === void 0 ? void 0 : options.languages) &&
    ...
    return new Set(
      options.languages
        .flatMap((lang) => {
          var _a;
          return (_a = exports.LANGUAGE_EXTENSION_MAP[lang]) !== null && _a !== void 0 ? _a : [];
        })
  ...
  return new Set(
    [
      ...exports.LANGUAGE_EXTENSION_MAP.javascript,
      ...exports.LANGUAGE_EXTENSION_MAP.typescript,
    ].map((ext) => ext.toLowerCase())
  );
}
